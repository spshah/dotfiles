...
profile_uuid='688d983d-b694-4c73-b567-5641cb948f57'
...
set_key "$gnome_terminal_settings_schema" 'default-show-menubar' 'true'

# parse the colors from Xresources
colorscheme_file=$HOME/setup/files/gnome_colorschemes/jvilla_solid
...
set_key "$profile_schema" 'audible-bell'                    "true" 
...
set_key "$profile_schema" 'scroll-on-output'                "true" 
